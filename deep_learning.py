...
train_generator = datagen.flow(X_train, y_train, batch_size=8)  # Batch size'ı düşürdüm
validation_generator = datagen.flow(X_val, y_val, batch_size=8)  # Batch size'ı düşürdüm
